...
### 풀이
문제를 잘 읽어보면 무엇을 묻는지 알 수있다. 공유기를 모두 배치하면서 동시에 두 공유기의 간격들 중 최소 간격의 길이가 최대한 길게 해야한다. 즉 두 공유기의 간격 중 최대값을 찾으면 된다.<br>
그럼 어떻게 찾냐? 간갹 min, max 중 조건을 따져가며 탐색하면 된다.
