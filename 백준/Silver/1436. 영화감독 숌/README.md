...
### 풀이
시간 복잡도 체크의 중요성을 깨닫게 해준 문제.<br>
로직 자체는 굉장히 단순한 브루스 포스인데, 난 수가 커질까봐 브루스 포스 방식을 쉽게 사용하지 못했다.
N값의 범위와 시간 제한을 체크하고 예제값을 확인하여 적절한 시간 복잡도의 로직을 떠올리는게 중요한 것 같다.
