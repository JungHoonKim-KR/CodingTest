...
### 풀이
이 문제는 어렵진 않은데, 조금만 생각하면 훨씬 쉽게 풀 수 있다. 이런 N/2로 나누는 문제는 한 쪽을 구하면 다른 쪽은 자동으로 구해진다. 다시 말해 true, false를 잘 활용하면 아주 쉽다.<br>
기억하자. 뒤집기 문제는 boolean visit 쓰기
