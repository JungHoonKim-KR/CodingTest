...
### 풀이
솔직히 제곱수만 약수의 개수가 홀수라는 것을 파악하지 못했고, 블로그의 도움을 받았다.<br>
실전에서 이런 문제가 나오면 멘탈 나갈 것 같다. 이런 문제는 지능 문제인가..... 규칙을 파악하는 능력을 어떻게 기를 수 있을까
