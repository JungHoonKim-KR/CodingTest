...
public class Solution {
    ...
    static PriorityQueue<Node> breedQueue;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int tc = 1; tc <= T; tc++) {
            ...
            breedQueue = new PriorityQueue<>((n1, n2) -> n2.originTime - n1.originTime);
    ...
    static void breed(Node cur){
        ...
        for (int j = 0; j < 4; j++) {
            ...
            if (!visit[moveX][moveY]) {
                pq.add(new Node(moveX, moveY, cur.originTime, cur.activeStartTime + cur.originTime + 1,
                        cur.originTime));
